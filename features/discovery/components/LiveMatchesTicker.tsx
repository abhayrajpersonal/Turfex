...
const LiveMatchesTicker: React.FC<LiveMatchesTickerProps> = ({ matches, onMatchClick }) => {
  ...
  return (
    <div className="overflow-x-auto pb-4 -mt-4 scrollbar-hide">
      <h3 className="text-xs font-bold text-volt uppercase tracking-wider mb-2 flex items-center gap-2 px-1">
      ...
      <div className="flex gap-4">
        {matches.map(match => (
          <button 
            ...
            className="bg-black text-white p-4 rounded-xl min-w-[280px] shadow-lg border border-zinc-800 hover:border-volt transition-colors text-left"
          >
            <div className="flex justify-between items-start mb-3">
              <div className="bg-volt text-black text-[10px] font-black px-2 py-0.5 rounded animate-pulse">LIVE</div>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xl font-black text-volt">
